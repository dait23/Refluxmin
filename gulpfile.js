...
gulp.task('react:test', function() {
  ...
  return gulp.src('./public/js/common/jiggie-bootstrap/jiggie-bootstrap.js')
          .pipe(webpack(wconfig))
          .pipe(rename('jiggie-bootstrap.test.js'))
          .pipe(gulp.dest('public/js/common/jiggie-bootstrap'));
});
