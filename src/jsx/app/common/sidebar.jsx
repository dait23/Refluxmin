  ...
  render() {
    return (
      <div>
            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-cart' name='Orders' href='/app/orders' />
                </SidebarNav>
              </div>
            </Col>
          </Row>
        </Grid>
        <hr style={{borderColor: '#bababa', borderWidth: 1, marginTop: 15, marginBottom: 0, width: 200}} />
        <Grid gutterBottom>
          <Row>
            <Col xs={12}>
        ...
        <hr style={{borderColor: '#bababa', borderWidth: 1, marginTop: 5, marginBottom: 0, width: 200}} />
      </div>
    );
  }
}
          ...
          <Grid>
            <Row className='fg-white'>
              <Col xs={4} collapseRight>
                <img src='/imgs/avatars/avatar.jpg' width='40' height='40' style={{borderRadius:'100%'}}/>
              </Col>
              <Col xs={8} collapseLeft id='avatar-col'>
                <div style={{top: 23, fontSize: 16, lineHeight: 1, position: 'relative'}}>Aditya Maulana</div>
                <div>
